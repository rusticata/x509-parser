...
/// For PEM-encoded certificates, use the [`pem`](pem/index.html) module.
#[inline]
pub fn parse_x509_certificate<'i>(i: &'i [u8]) -> X509Result<'i, X509Certificate<'i>> {
...
/// for more information.
#[inline]
pub fn parse_x509_crl<'i>(i: &'i [u8]) -> X509Result<'i, CertificateRevocationList<'i>> {
...
#[inline]
pub fn parse_x509_der<'i>(i: &'i [u8]) -> X509Result<'i, X509Certificate<'i>> {
    X509Certificate::from_der(i)
}
...
#[inline]
pub fn parse_crl_der<'i>(i: &'i [u8]) -> X509Result<'i, CertificateRevocationList<'i>> {
    CertificateRevocationList::from_der(i)
}
